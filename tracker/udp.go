...
func (tr *Tracker) udpStarted(conn connect.Conn) ([]peer.Peer, error) {
    ...
    binary.BigEndian.PutUint32(packet[12:16], tr.txID)  // Transaction ID
    copy(packet[16:36], tr.info.InfoHash[:])  // Info Hash
    copy(packet[36:56], tr.info.PeerID[:])  // Peer ID
    binary.BigEndian.PutUint64(packet[56:64], uint64(tr.info.TotalLength - tr.info.Left))  // Downloaded
    binary.BigEndian.PutUint64(packet[64:72], uint64(tr.info.Left))  // Left
    ...
    binary.BigEndian.PutUint16(packet[96:98], tr.port)  // Port
